...
client.on('interactionCreate', async interaction => {
    ...
    // Add defer if command might take time
    try {
        await interaction.deferReply();
    } catch (deferError) {
        Logger.warning(`Could not defer reply: ${deferError.message}`);
    }
...
client.on('messageCreate', message => {
    ...
    // 📊 Günlük komut sayacını güncelleKomut
